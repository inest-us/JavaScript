...
console.log(xmas.getDate()); // Returns 21, not the original value of 25
...
console.log(xmas == solstice); // Evaluates to true
...
console.log(xmas != solstice_plus_4); // Evaluates to true
